...
There were `r nrow(coffee_survey)` participants. Among male participants, the median (IQR) age was `r inline_text(coffee_table, variable = "age", column = "stat_1")`years.
