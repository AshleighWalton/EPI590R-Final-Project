...
There were `r nrow(coffee_survey)` participants. Among male participants, `r inline_text(coffee_table, variable = "employment_status", level = "Full-time", column = "stat_1")` were employed full-time.
